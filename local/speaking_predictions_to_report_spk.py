...
infos = ["text_id", "anno", "anno(cefr)", "pred", "pred(cefr)"]
...
for score in scores: 
    for nf in n_folds: 
        ...
        total_losses[score][nf], all_score_preds, all_score_annos, all_text_ids = evaluation(total_losses[score][nf], csv_dict[nf], score, all_bins)
        kfold_dir = os.path.join(result_root, score, nf) 
...
for score in scores:
    ...
    for nf in n_folds: 
        total_losses[score][nf] = {}
        total_losses[score][nf], all_score_preds, all_score_annos, all_text_ids = evaluation(total_losses[score][nf], csv_dict[nf], score, cefr_bins)
        kfold_dir = os.path.join(result_root, score, nf) 
